...
SN <- function(data, Kmax) {
    .Call(`_changepoints_SN`, data, Kmax)
}
...
SVP <- function(data, gamma, test, prune_if_unvalid = TRUE) {
    .Call(`_changepoints_SVP`, data, gamma, test, prune_if_unvalid)
}
...
svp0 <- function(data, gamma, test, prune_if_unvalid = TRUE, prune_if_PELT = FALSE) {
    .Call(`_changepoints_svp0`, data, gamma, test, prune_if_unvalid, prune_if_PELT)
}
